...
requestBody: OfficeHoursArea,
        ...
        return this.httpRequest.request({
            method: 'POST',
            url: '/towns/{townID}/officeHoursArea',
            path: {
                'townID': townId,
            },
            headers: {
...
xSessionToken: string,
     ...
     * @throws ApiError
     */
    public removeOfficeHoursQuestionForPlayer(
townId: string,
officeHoursAreaId: string,
xSessionToken: string,
): CancelablePromise<OfficeHoursArea> {
        return this.httpRequest.request({
            method: 'PATCH',
            url: '/towns/{townID}/{officeHoursAreaId}/removeQuestionForPlayer',
            path: {
                'townID': townId,
                'officeHoursAreaId': officeHoursAreaId,
            },
